...
Route::get('decrement_actual/{col_selector}/{machine_no}/{type}/{area}/{model}', 'UserController@decDataActual')   ->name('dec_actual');
Route::get('increment_test_block/{col_selector}/{machine_no}/{type}/{area}/{model}', 'UserController@incDataTestBlock')->name('inc_test_block');
Route::get('decrement_test_block/{col_selector}/{machine_no}/{type}/{area}/{model}', 'UserController@decDataTestBlock')->name('dec_test_block');
Auth::routes([
   'register' => false,
   'verify'   => false,
   'reset'    => false,
